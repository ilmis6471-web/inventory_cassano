...
(function(){
  ...
  window.dash=async function(){
    ...
    try{
      ...
      el.innerHTML=`
        <div class="dashWelcome"><div><h2>Selamat datang, ${esc(me.name)} 👋</h2><p>Pantau kondisi Inventory Cassano dari satu tempat.</p></div><span class="dashRole">${esc(me.role)}</span></div>
        <div class="dashGrid">
