// Inventory Cassano - Premium $ Command Center
(function(){
  const fmt=n=>new Intl.NumberFormat('id-ID',{style:'currency',currency:"USD",maximumFractionDigits:0}).format(Number(n)||0);
  ...
  aside .side{border-bottom:1px solid #24262d;margin-bottom:8px}.side b{color:#f3f3f5}.side b:after{content:' • $';color:#c51632;font-size:9px;letter-spacing:1px}.me{background:linear-gradient(145deg,#111217,#171016)}nav button{transition:background .18s,transform .18s,color .18s}nav button:hover{transform:translateX(2px)}
